package com.iqmsoft.configuration.mybatis;
...
import com.iqmsoft.configuration.JdbcConnectionSettings;


@Configuration
@MapperScan(basePackages = "com.iqmsoft.mapper")
public class MybatisConfig {
	...
	public SqlSessionFactory sqlSessionFactory() throws Exception {
		...
		sqlSessionFactory.setTypeHandlersPackage("com.iqmsoft.configuration.mybatis.typehandler");
